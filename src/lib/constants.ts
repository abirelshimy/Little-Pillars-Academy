export const SITE = {
  ...
  description:
    "Little Pillars Academy is an Islamic preschool in Johns Creek, GA offering full-day childcare for children ages 9 months to 4 years in a nurturing, faith-based environment.",
